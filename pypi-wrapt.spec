...
Source0  : https://files.pythonhosted.org/packages/24/a1/fc03dca9b0432725c2e8cdbf91a349d2194cf03d8523c124faebe581de09/wrapt-1.17.0.tar.gz
...
%prep
%setup -q -n wrapt-1.17.0
cd %{_builddir}/wrapt-1.17.0
pushd ..
cp -a wrapt-1.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732288679
